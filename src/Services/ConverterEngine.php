...
class ConverterEngine
{
    ...
    private $normalMonths = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]; // 17 - 1
    private $leapMonths = [31, 29, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31]; // 7 - 1, 0 for sunday, 6 for saturday

    /*These are initial values for nepali date.*/

    public function parseFromCarbon(Carbon $date)
    {
        $this->year  = $date->year;
